...
<head>
    ...
    <title>Address - Managment System</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('/dashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">address management</div>
            </a>
...
<!-- Nav Item - Pages Collapse Menu -->
     ...
     <a class="collapse-item" href="">View User</a>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="">Change Profile</a>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item @if ($main_menu == 'Division') active @endif">
                ...
                <div id="collaspefour" class="collapse @if($main_menu == 'Division') show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item  @if($sub_menu == 'View') active @endif" href="{{ route('division')  }}">View Division</a>
 ...
 <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item @if($main_menu == 'District') active @endif">
                ...
                <div id="collapsefive" class="collapse @if($main_menu == 'District') show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item @if($sub_menu == 'View') active @endif" href="{{ url('district') }}">View District</a>
 ...
 <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item @if($main_menu == 'Upazilla') active @endif">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsnine"
                   ...
                   <i class="fa fa-check-square" aria-hidden="true"></i>
                    <span>Manage Upazilla</span>
                </a>
                <div id="collapsnine" class="collapse @if($main_menu == 'Upazilla') show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item @if($sub_menu == 'View') active @endif" href="{{ url('upazilla') }}">View Upazilla</a>
